...
class App extends Component {
  ...
  async onConnect() {
    ...
    try {
      ...
      if (+chainId === 4) {
        ...
        creoToken = "0x20C68d0d477E2887a57190Ab7c4E88DAFE42588c";
        lpToken = "0x75385E7c2E9946C11c40633A2eFFa6ED26A4Bf9C";
        creoLpFarm = "0x831cC40d73eD931c16EfF8c202f548DaBf6DbdEE";
        lpLpFarm = "0xc415d76D5efaCCFc42AA0d0Bb3Fa787CEb87Cbe3";
        lpCreoFarm = "0xa54a9F859e3003206Fe675d193D0D55C0c7629bb";
      } else if (+chainId === 97) {
  ...
  async getAccountAssets() {
    ...
    if (creoToken && address && lpToken && creoLpFarm) {
